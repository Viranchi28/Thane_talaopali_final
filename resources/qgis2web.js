...
map.getView().fit([8123069.466013, 2177363.252460, 8124529.777166, 2178011.051352], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Thane : Talao Pali</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (180 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'ELEVATOR PITCH<br /><br />Exploring the intimate dynamics of couples in Thane\'s Talao Pali area through behavioural mapping concerning urban design settings.<br /><br />- by Ar. Viranchi Sinha (KRVIA)';
            }
